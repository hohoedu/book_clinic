            ...
            <section class="menu_cont mb-5">
                <div class="card">
                    ...
                    <div class="row g-3 justify-content-between" style="--bs-gutter-x:0rem;">
                        ...
                        <label class="col-10 col-sm-2 gap-2 input param" style="border:none;">resultMessage</label>
                        <label class="col-10 col-sm-9 reinput">
                            <%=paramMap.get("resultMessage") %>
                        </label>
						
                        <label class="col-10 col-sm-2 gap-2 input param" style="border:none;">tid</label>
                        <label class="col-10 col-sm-9 reinput">
                            <%=paramMap.get("tid") %>
                        </label>
						...
						<label class="col-10 col-sm-2 input param" style="border:none;">billkeyDate</label>
                        <label class="col-10 col-sm-9 reinput">
                            <%= paramMap.get("billkeyDate") %>
                        </label>
						
						<label class="col-10 col-sm-2 input param" style="border:none;">billkeyTime</label>
                        <label class="col-10 col-sm-9 reinput">
                            <%=paramMap.get("billkeyTime") %>
                        </label>
 
                    </div>
                </form>
				
				<button onclick="location.href='INIbill_mo_req_new.jsp'" class="btn_solid_pri col-6 mx-auto btn_lg" style="margin-top:50px">돌아가기</button>
