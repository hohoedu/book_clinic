...
-- 문제 유형 설명 (2026-09-21) — 학생 문제풀이 화면 유형 안내 문구. 유형 이름은 erp_bookstore_code(gubun='T')에 있다
INSERT INTO erp_bookstore_qtype_desc (qtype, qtype_desc, use_yn, updated_by) VALUES
('01', N'등장인물과 사건, 행동 등 중요한 내용을 정확하게 파악하는 능력이에요. 이야기 속 중요한 내용을 잘 떠올려 보세요!', 1, 'seed'),
('02', N'다양한 표현의 뜻과 쓰임을 알고, 그 속에 담긴 의미를 이해하는 능력이에요. 표현에 집중해 문제를 풀어 보세요!', 1, 'seed'),
('03', N'이야기의 앞뒤 내용을 연결하여 원인과 결과, 사건의 관계를 파악하는 능력이에요. 문제의 단서를 연결해서 생각해 보세요!', 1, 'seed'),
('04', N'인물의 행동과 선택을 살펴보고, 이야기의 주제와 의미를 생각하는 능력이에요. 왜 그런지, 무엇을 말하고 있는지 생각해 보세요!', 1, 'seed'),
('05', N'인물의 말과 행동을 통해 마음과 감정을 이해하는 능력이에요. 인물의 입장이 되어 마음을 헤아려 보세요.', 1, 'seed'),
('06', N'이야기에 나온 낱말의 뜻과 쓰임을 문맥에 맞게 이해하는 능력이에요. 앞뒤 내용을 살펴 낱말의 뜻을 생각해 보세요!', 1, 'seed'),
('07', N'책에서 출발해 관련된 배경지식과 새로운 정보로 지식을 넓혀 가는 능력이에요. 새로운 지식을 발견해 배움의 폭을 넓혀요!', 1, 'seed'),
('08', N'핵심 어휘를 한자의 뜻과 함께 풀어보며 문맥 속 의미를 이해하는 능력이에요. 풍부한 어휘력으로 이야기를 더 깊이 이해해 보세요!', 1, 'seed'),
('09', N'책 속 낱말과 문장을 이해하고, 국어문법과 다양한 표현을 알맞게 활용하는 능력이에요. 문제를 풀며 국어 실력을 키워 보세요!', 1, 'seed');
...
-- 뱃지 마스터 (1~4) — 달성 조건은 category로 데이터화 (판정: ClinicService.awardBasicBadge/awardAdvancedBadge)
-- 모두 "처음 1회 달성 시" 획득하는 단발 업적이라 threshold는 1, param은 사용하지 않는다.
-- 2026-09-02: 5종 → 4종. 기존 1번(참 잘했어요!, 기본 불합격)과 2번(독서친구)을 "독서완료"로 합쳤다 —
-- 기본 문제를 풀기만 하면 합격/불합격 무관하게 독서완료 뱃지를 준다(아이콘도 badge_1~4.png로 축소).
-- badge_name은 아이콘 이미지에 그려진 문구와 반드시 같아야 한다(결과화면이 이미지+이름을 함께 보여줌).
--   BASIC_PASS    : 기본(01) 문제 제출 완료 — 합격/불합격(재도전) 공통
...
-- 권장도서 순위(erp_bookstore_priority_draft / erp_bookstore_priority) 시딩은 data-priority.sql로 옮겼다 (2026-09-02) —
-- 화면에서 편집한 순위가 재기동 때 초기화되지 않도록 priority 계열을 리셋 제외 그룹으로 뺐다.
-- 처음 구축하는 DB에서는 data-priority.sql을 한 번 수동 실행한다.
